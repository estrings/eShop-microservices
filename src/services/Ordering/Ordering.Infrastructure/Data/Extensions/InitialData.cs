...
internal class InitialData
{
    ...
    new List<Customer>
    {
        ...
        Customer.Create(CustomerId.Of(new Guid("599dc8dc-990f-48e0-a37b-e6f2b60b9daf")), "Ejokpe Ejeguo", "trustlead01@gmail.com")
    };
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            ...
            var address3 = Address.Of("Ejokpe", "Ejeguo", "trustlead01@gmail.com", "Plot 2237 Joseph Orru Street, Unity Estate", "Nigeria", "Lagos", "10210");

            var payment1 = Payment.Of("mehmet", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("john", "8885555555554444", "06/30", "222", 2);
            var payment3 = Payment.Of("Ejokpe", "5885555555554445", "03/29", "326", 3);
            ...
            var order3 = Order.Create(
                           OrderId.Of(Guid.NewGuid()),
                           CustomerId.Of(new Guid("599dc8dc-990f-48e0-a37b-e6f2b60b9daf")),
                           OrderName.Of("ORD_3"),
                           shippingAddress: address3,
                           billingAddress: address3,
                           payment3);
            order3.Add(ProductId.Of(new Guid("4f136e9f-ff8c-4c1f-9a33-d12f689bdab8")), 1, 650);
